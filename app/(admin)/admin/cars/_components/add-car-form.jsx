    ...
    validFiles.forEach((file) => {
      ...
      reader.onload = (e) => {
        ...
        if (newImages.length === validFiles.length) {
          // All images processed, update state or form value here
        ...
        <TabsContent value="ai" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload an image of a car and let AI extract the details for you.
              </CardDescription>
              <CardAction>Card Action</CardAction>
            </CardHeader>
            <CardContent>
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-gray-600 text-sm mb-2">
                          "Drag & Drop a car image or click to upload car image"
                        </p>
